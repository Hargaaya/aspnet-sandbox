    ...
    public class AppDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<UserEvent>().HasData(
                new UserEvent { Id = ORG_USER_ID, EventId = 1, Title = "Spaghetti harvesting festival", Description = "Stora affärer is hosting a festival to start of this years spaghetti harvest in Italy", Address = "Grazie 15, 957864 Pregi", Date = new DateTime(2022, 4, 12), SpotsAvailable = 40, Place = "Mi scusi" },
                new UserEvent { Id = ORG_USER_ID, EventId = 2, Title = "Lil Pest Listening party", Description = "The cockroach Lil Pest is having a listening party for his 9th album", Address = "Sveavägen 73, 113 80 Stockholm", Date = new DateTime(2022, 3, 31), SpotsAvailable = 120, Place = "Stadsbiblioteket" },
                new UserEvent { Id = ORG_USER_ID, EventId = 3, Title = "World of Concrete", Description = "Annual international event dedicated to the commercial concrete and masonry construction industries.", Address = "Humongous Street 23, 80468 Las Vegas, Nevada", Date = new DateTime(2023, 5, 12), SpotsAvailable = 1500, Place = "The Gazino" },
                new UserEvent { Id = ORG_USER_ID, EventId = 4, Title = "CES 2022", Description = "The show will display the next wave of innovation that will shape 2022", Address = "Big Avenue, 90652 Dallas, Texas", Date = new DateTime(2023, 1, 2), SpotsAvailable = 1000, Place = "Big Avenue" },
                new UserEvent { Id = ORG_USER_ID, EventId = 5, Title = "Lorem ipsum Conference", Description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed to", Address = "Lorem 23, 0xFFFF Ipsum", Date = new DateTime(2022, 6, 21), SpotsAvailable = 5, Place = "127.0.0.1" });
